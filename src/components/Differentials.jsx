    ...
    const differentials = [
        {
            ...
            desc: "Histórico completo de decisões e revisões." // shortened for grid
        },
        {
            icon: Users,
            title: "Coordenação Ativa",
            desc: "Comunicação fluida entre todas as disciplinas."
        },
        {
            icon: CloudLightning,
            title: "Integração MakeDrive",
            desc: "Gestão inteligente de arquivos e prazos."
        },
        {
            icon: FileBarChart2,
            title: "Método Ágil & Engenharia Clara",
            desc: "Processos definidos que evitam surpresas."
        }
    ];
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="text-white order-1 lg:order-1">
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight font-heading">
                            Por que grandes players escolhem a <span className="text-brand-red">DRC Pro</span>?
                        </h2>
                        <p className="text-gray-400 text-base md:text-lg mb-8 max-w-md">
                            Não entregamos apenas desenhos. Entregamos inteligência de engenharia, organização e previsibilidade para o seu empreendimento.
                        </p>
                    ...
                    <div className="order-2 lg:order-2 relative h-full min-h-[300px] md:min-h-[400px] border border-white/10 rounded-2xl bg-white/5 backdrop-blur-sm p-6 md:p-8 flex flex-col justify-center mb-8 lg:mb-0">
                        ...
                        <div className="space-y-8 relative">
                            ...
                            {[
                                { num: '01', label: 'Análise de Riscos & Conflitos', width: '40%' },
                                { num: '02', label: 'Compatibilização BIM Avançada', width: '70%' },
                            ...
                            <div className="mt-8 p-6 bg-brand-red/90 rounded-xl text-white text-center transform rotate-1 hover:rotate-0 transition-transform cursor-default">
                                <p className="font-bold text-xl">Zero Atrasos</p>
                                <p className="text-xs opacity-80 uppercase tracking-widest mt-1">Meta Garantida</p>
                            </div>
                        </div>
                    </div>
                </div>
